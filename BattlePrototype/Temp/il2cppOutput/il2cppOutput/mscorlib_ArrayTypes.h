...
// System.Collections.Generic.List`1<Tile>[]
struct List_1U5BU5D_t1343766059  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) List_1_t1370792350 * m_Items[1];

public:
	inline List_1_t1370792350 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline List_1_t1370792350 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, List_1_t1370792350 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
